(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    try {
      ...
      // initializeNavigation(); // Commented out as requested
  ...
  function initializeNavigation() {
    ...
    document.addEventListener("click", function (e) {
      if (
        ...
        !e.target.closest(".carousel-dots-wrapper") && // Exclude carousel dots
        !e.target.closest(".carousel-nav-btn") // Exclude carousel nav buttons
      ) {
        document
  ...
  */
  ...
  function initializeOwlCarousel() {
    ...
    function initializeCarousel($carousel) {
      ...
      const itemsCount =
        $carousel.find(".carousel-testimonial-item").length || 3;
      ...
      $dots.on("click", ".carousel-dot-btn", function () {
        ...
        $carousel.trigger("to.owl.carousel", [to, 450, true]);
      });
